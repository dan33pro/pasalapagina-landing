  ...
  return (
    <article className="flex flex-col h-main text-white items-center justify-center gap-y-10">
        <div className="flex flex-col items-center justify-center gap-y-2">
            ...
            <h3 className="flex items-center justify-center h-18 font-bold text-[var(--white-colo)] text-6xl custom-text-shadow">{user.name}</h3>
        </div>
        <div className="flex flex-col items-center justify-center gap-y-4">
            ...
            <p className="text-center custom-font text-[var(--yellow-color)] text-5xl font-extrabold rotate-[-4deg] custom-text-shadow">SUSCRIPCIÓN <br /><span className="text-6xl">ANUAL</span></p>
        </div>
